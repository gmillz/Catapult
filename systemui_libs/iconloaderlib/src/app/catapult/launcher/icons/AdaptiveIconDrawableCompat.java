 ...
 */
public class AdaptiveIconDrawableCompat extends AdaptiveIconDrawable implements Drawable.Callback {
    ...
    AdaptiveIconDrawableCompat(@Nullable LayerState state, @Nullable Resources res) {
        ...
        if (sMask == null) {
            sMask = new AdaptiveIconDrawable(null, null).getIconMask();
        }
    ...
    public static @NonNull Drawable wrapNonNull(@NonNull Drawable icon) {
        if (icon.getClass() == AdaptiveIconDrawable.class) {
            return new AdaptiveIconDrawableCompat((AdaptiveIconDrawable) icon);
        }
        return icon;
    }
     ...
     */
    public AdaptiveIconDrawableCompat(@Nullable Drawable backgroundDrawable,
    ...
    private AdaptiveIconDrawableCompat(AdaptiveIconDrawable drawable) {
        this(drawable.getBackground(), drawable.getForeground());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (drawable.getMonochrome() != null) {
                addLayer(MONOCHROME_ID, createChildDrawable(drawable.getMonochrome()));
            }
        }
    }
